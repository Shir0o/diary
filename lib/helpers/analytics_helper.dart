...
class AnalyticsHelper {
  ...
  static int calculateCurrentStreak(List<DiaryEntry> entries, {DateTime? relativeTo}) {
    ...
    int streak = 0;
    DateTime currentDay = DateTime(referenceDate.year, referenceDate.month, referenceDate.day);
  ...
  static List<DayActivity> getWeeklyActivity(List<DiaryEntry> entries, {DateTime? relativeTo}) {
    final referenceDate = relativeTo ?? DateTime.now();
