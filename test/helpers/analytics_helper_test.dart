...
void main() {
  ...
  test('calculateCurrentStreak returns correct streak', () {
    ...
    expect(AnalyticsHelper.calculateCurrentStreak(entries, relativeTo: today), equals(3));
  });
  ...
  test('getWeeklyActivity returns entry counts for last 7 days', () {
    final today = DateTime(2026, 4, 24);
    final activity = AnalyticsHelper.getWeeklyActivity(entries, relativeTo: today);
