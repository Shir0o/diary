...
void main() {
  ...
  testWidgets(
    'ArchiveScreen displays entries, headers, and badges correctly',
  ...
  testWidgets(
    'ArchiveScreen swipe right to restore in Archived tab',
    (WidgetTester tester) async {
      String? restoredId;
  ...
  testWidgets(
    'ArchiveScreen swipe left to trash in Archived tab',
    (WidgetTester tester) async {
      String? deletedId;
  ...
  testWidgets(
    'ArchiveScreen empty trash confirmation works',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'ArchiveScreen permanent delete confirmation works',
    (WidgetTester tester) async {
