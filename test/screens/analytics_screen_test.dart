...
void main() {
  ...
  testWidgets('AnalyticsScreen renders correctly with data', (WidgetTester tester) async {
  ...
  testWidgets('AnalyticsScreen handles empty state', (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: AnalyticsScreen(entries: []),
    ));
